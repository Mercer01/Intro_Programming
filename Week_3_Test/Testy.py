...
def biscuitCutting():
    ...
    width = int(
        input("Please enter the number of biscuits along the width of the mixture: "))
    length = int(
        input("Please enter the number of biscuits along the length of the mixture: "))
    ...
    print("With the leftover batter " +
          str(int(leftover_biscuits)) + " biscuit's could be made")
